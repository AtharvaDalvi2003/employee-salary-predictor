...
# Load and clean data
data = pd.read_csv("employee_income_data.csv")
...
joblib.dump(X.columns.tolist(), "input_columns_config.pkl")

# Save test data for visualization in app
joblib.dump((X_test, y_test, model.predict(X_test)), "model_test_output.pkl")
